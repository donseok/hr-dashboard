  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">인재 라이프사이클</h1>
          <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
            채용부터 퇴직까지 통합 인재 여정 분석
          </p>
        </div>
      ...
      <FilterPanel onReset={resetFilters}>
        ...
        />
        <DepartmentSelect
          departments={lifecycleDepartments}
          value={departments}
