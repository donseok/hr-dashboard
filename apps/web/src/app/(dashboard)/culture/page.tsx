  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100">조직 문화</h1>
          <p className="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
            몰입도, eNPS 및 조직 문화 건강도 분석
          </p>
        </div>
      ...
      <FilterPanel onReset={resetFilters}>
        ...
        />
        <DepartmentSelect
          departments={cultureDepartments}
          value={departments}
